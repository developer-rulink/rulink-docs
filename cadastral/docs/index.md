...
Если кадастровый номер существует, информация отобразится в виде сводной информационной таблицы. Если нет — попробуйте указать другой кадастровый номер.
...
??? abstract "Что такое кадастровый номер"
    ...
    Номер имеет 4 части, разделённые двоеточием, и выглядит как 77:01:0450400:1233.
...
Если информация по адресу найдена, результат отобразится в виде таблицы объектов с указанием кадастрового номера. Если нет — попробуйте указать другой адрес.

Далее по кадастровому номеру можно получить подробную информацию об объекте недвижимости.

!!! note "Совет"
    Если адрес указан с точностью до дома, результатом будет список всех квартир и других зданий по этому адресу.
...
Описание API: [https://cadastral.rulink.io/api/v1/swagger](https://cadastral.rulink.io/api/v1/swagger)
