...
**Пользователь** — любой посетитель сайта [https://rulink.io](https://rulink.io?utm_source=legal&utm_medium=confidential) и его подразделов.
...
- предоставление функционала отправки данных в ИС Госключ, с последующей передачей данных в мобильное приложение пользователей.
...
[https://rulink.io/legal/agreement/](https://rulink.io/legal/agreement/?utm_source=legal&utm_medium=confidential)
...
- адрес электронной почты (email);
- СНИЛС;
- история запросов и просмотров на сайте [https://rulink.io](https://rulink.io?utm_source=legal&utm_medium=confidential) (далее — Сайт), подразделов сайта и его сервисах;
- файлы cookie, сведения о местоположении пользователя, сведения о действиях пользователя на Сайте, сведения об оборудовании пользователя, дата и время сессии.
