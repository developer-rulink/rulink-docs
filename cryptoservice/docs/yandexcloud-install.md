...
Если у вас есть настроенный сервис Identity используйте настройки подключения, существующего сервиса. Подробнее, как настроить сервис **Identity** тут: [https://rulink.io/support/auth/initial/](https://rulink.io/support/auth/initial/)
