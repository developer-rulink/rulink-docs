...
!!! info
    При загрузке электронной подписи выполняется проверка на соответствие формату. Если файл не соответствует формату электронной подписи, он не будет загружен.
...
!!! info "Кстати"
    Этот функционал можно использовать бесплатно и без регистрации. [Работает здесь](https://crypto-demo.rulink.io/signatures?utm_source=support&utm_medium=crypto&utm_campaign=verification).
...
В протоколе проверки указываются все параметры проверки подписи.

- Зелёный фон — подпись действительна
...
- Сведения о сертификате
  ...
  - Текущий статус — действующий или срок действия истёк
