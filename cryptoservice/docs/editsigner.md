...
!!! info "Кстати"
    Этот функционал можно использовать бесплатно и без регистрации. [Работает здесь](https://crypto-demo.rulink.io/signatures/editors?utm_source=support&utm_medium=crypto&utm_campaign=edit).
...
После редактирования списка подписантов нажмите кнопку =="Выгрузить объединённую подпись"==.
