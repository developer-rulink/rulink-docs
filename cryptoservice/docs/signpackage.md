...
Для каждого подписанта будет отображет раздел с документами для подписания.  
У каждого документа есть возможность скачать файл и добавить подпись. Возможность скачать файл обеспечивает возможность посмотреть документ перед подписанием (требование ФЗ-63).  
Добавление подписи будет востребовано, если подписант оформил подпись в помощью других сервисов или получил ее (например, от нотариуса).  
