...
3. Укажите корректный файл конфигурации ssl для сервиса
    - Для wildcard-сертификатов авторизованного центра: см. [TLS-сертификаты](tls.md), Настройка, Шаг 2.
    - Для самоподписанных сертификатов: см. [TLS](tls.md), «Как создать и настроить самоподписанный сертификат», Пункт 2.
