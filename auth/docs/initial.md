...
Сервис поставляется в виде контейнера Docker. Ниже приведены шаги для первоначальной настройки сервера аутентификации.
...
Сервис аутентификации использует PostgreSQL в качестве базы данных. Убедитесь, что у вас есть доступ к серверу PostgreSQL.
...
!!! note "Важно"
    Пользователь должен иметь права на создание таблиц и индексов в базе данных.
