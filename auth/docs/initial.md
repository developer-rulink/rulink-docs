...
- [x] Добавьте пользователю роль `admin` для управления сервисом аутентификации.
- [x] Выйдите из системы и войдите снова с новым пользователем.
- [x] Убедитесь, что вы можете войти в систему с новым пользователем.
- [x] Смените пароль локального пользователя и сохраните его в надежном месте.
- [x] Убедитесь, что вы можете войти в систему с новым паролем.
...
```
Сохраните файл и перезапустите сервис аутентификации:
```bash
sudo bash /opt/services/updates/update-identity.sh
```
